...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("dad2ed5f-dd83-4b0f-8083-9fd0eae1c0f3/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=209, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=3344, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=Threshold_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Threshold_1, CY_INSTANCE_SHORT_NAME=Threshold_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Threshold_1, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=103, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=1648, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=Trigger_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Trigger_1, CY_INSTANCE_SHORT_NAME=Trigger_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Trigger_1, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=true, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=4, CompareType2Software=0, CompareValue1=3838, CompareValue2=3838, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=true, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=1, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=false, Period=38378, PWMMode=1, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=false, TermVisibility_pwm1=true, TermVisibility_pwm2=true, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_1, )
module PWM_v3_30_6 (
    reset,
    clock,
    tc,
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=255, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=4080, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_1, CY_INSTANCE_SHORT_NAME=VDAC_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=VDAC_1, )
...
// PGA_v2_0(Gain=1, Power=1, VddaValue=5, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONFIG_TITLE=PGA_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_2, CY_INSTANCE_SHORT_NAME=PGA_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PGA_2, )
module PGA_v2_0_8 (
    Vin,
    Vref,
    Vout);
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=0, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4095, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Counter_1, )
...
module top ;
	...
	wire [0:0] tmpOE__Temperatursensor_net;
	wire [0:0] tmpFB_0__Temperatursensor_net;
	wire [0:0] tmpIO_0__Temperatursensor_net;
	wire [0:0] tmpINTERRUPT_0__Temperatursensor_net;
	electrical [0:0] tmpSIOVREF__Temperatursensor_net;
	...
	cy_psoc3_pins_v1_10
		...
		Temperatursensor
		 (.oe(tmpOE__Temperatursensor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Temperatursensor_net[0:0]}),
		  .analog({Net_2}),
		  .io({tmpIO_0__Temperatursensor_net[0:0]}),
		  .siovref(tmpSIOVREF__Temperatursensor_net),
		  .interrupt({tmpINTERRUPT_0__Temperatursensor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Temperatursensor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Discharge_net;
	wire [0:0] tmpFB_0__Discharge_net;
	wire [0:0] tmpIO_0__Discharge_net;
	wire [0:0] tmpINTERRUPT_0__Discharge_net;
	electrical [0:0] tmpSIOVREF__Discharge_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Discharge
		 (.oe(tmpOE__Discharge_net),
		  .y({Net_433}),
		  .fb({tmpFB_0__Discharge_net[0:0]}),
		  .io({tmpIO_0__Discharge_net[0:0]}),
		  .siovref(tmpSIOVREF__Discharge_net),
		  .interrupt({tmpINTERRUPT_0__Discharge_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Discharge_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("0b914227-dae4-4f70-b51b-7480469eaa5e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    VDAC8_v1_90_2 Threshold_1 (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_87));
    defparam Threshold_1.Data_Source = 0;
    defparam Threshold_1.Initial_Value = 209;
    defparam Threshold_1.Strobe_Mode = 0;

    VDAC8_v1_90_3 Trigger_1 (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_81));
    defparam Trigger_1.Data_Source = 0;
    defparam Trigger_1.Initial_Value = 103;
    defparam Trigger_1.Strobe_Mode = 0;
    ...
    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_386)
    begin
        cy_srff_1 <= (Net_135 | Net_433) & ~Net_197;
    end
    assign Net_433 = cy_srff_1;
    // -- SRFF End --
	...
	cy_clock_v1_0
		#(.id("6b28da71-09f7-42f3-a11b-a07183049012"),
    ...
    VDAC8_v1_90_7 VDAC_1 (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_126));
    defparam VDAC_1.Data_Source = 0;
    defparam VDAC_1.Initial_Value = 255;
    defparam VDAC_1.Strobe_Mode = 0;
	...
	wire [0:0] tmpOE__Drucksensor_net;
	wire [0:0] tmpFB_0__Drucksensor_net;
	wire [0:0] tmpIO_0__Drucksensor_net;
	wire [0:0] tmpINTERRUPT_0__Drucksensor_net;
	electrical [0:0] tmpSIOVREF__Drucksensor_net;

	cy_psoc3_pins_v1_10
		#(.id("27500851-a40b-4139-9c7b-99410dfb562f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Drucksensor
		 (.oe(tmpOE__Drucksensor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Drucksensor_net[0:0]}),
		  .analog({Net_125}),
		  .io({tmpIO_0__Drucksensor_net[0:0]}),
		  .siovref(tmpSIOVREF__Drucksensor_net),
		  .interrupt({tmpINTERRUPT_0__Drucksensor_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Drucksensor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_v3_10_10 ADC_2 (
        .vplus(Net_127),
        .vminus(Net_457),
        .soc(1'b0),
        .eoc(Net_459),
    ...
    UART_v2_50_11 UART_1 (
        ...
        .reset(Net_178),
        .rx(1'b0),
        .tx_interrupt(Net_529),
        .rx_interrupt(Net_530),
        .tx_data(Net_531),
        .tx_clk(Net_532),
        .rx_data(Net_533),
        .rx_clk(Net_534));
