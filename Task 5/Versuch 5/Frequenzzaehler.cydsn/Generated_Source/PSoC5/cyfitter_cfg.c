...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480003FCu)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x4800040Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP3_SW4, 0xA0u);
