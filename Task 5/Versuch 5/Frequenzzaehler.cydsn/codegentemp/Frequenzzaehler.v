// ======================================================================
// Frequenzzaehler.v generated from TopDesign.cysch
// 07/13/2020 at 19:13
...
module CharLCD_v2_20_7 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("11ff02f1-4b73-4523-86fa-cb1c58ee3e41/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("5b0c0ec4-beb4-41d3-b314-761ed0a1978f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_6 UART_1 (
        ...
        .reset(Net_383),
        .rx(1'b0),
        .tx_interrupt(Net_385),
        .rx_interrupt(Net_387),
        .tx_data(Net_388),
        .tx_clk(Net_389),
        .rx_data(Net_390),
        .rx_clk(Net_391));
