// ======================================================================
// ADW versenden.v generated from TopDesign.cysch
// 07/10/2020 at 13:56
...
module CharLCD_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b6d91fb2-7eaa-46c4-810c-6d99cfed0ea2/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Sensorspannung_net;
	wire [0:0] tmpFB_0__Sensorspannung_net;
	wire [0:0] tmpIO_0__Sensorspannung_net;
	wire [0:0] tmpINTERRUPT_0__Sensorspannung_net;
	electrical [0:0] tmpSIOVREF__Sensorspannung_net;
	...
	cy_psoc3_pins_v1_10
		...
		Sensorspannung
		 (.oe(tmpOE__Sensorspannung_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sensorspannung_net[0:0]}),
		  .analog({Net_2}),
		  .io({tmpIO_0__Sensorspannung_net[0:0]}),
		  .siovref(tmpSIOVREF__Sensorspannung_net),
		  .interrupt({tmpINTERRUPT_0__Sensorspannung_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sensorspannung_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("dbbbb0e9-5aba-4ddd-94e3-66c9d93fbb7f"),
